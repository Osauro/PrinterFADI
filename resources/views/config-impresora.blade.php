                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="connectionType" name="connection_type">
                                                <option value="network" {{ $configuracion['tipo_conexion'] == 'network' ? 'selected' : '' }}>Red/IP (cPanel/Web)</option>
                                                <option value="bluetooth" {{ $configuracion['tipo_conexion'] == 'bluetooth' ? 'selected' : '' }}>Bluetooth</option>
                                                <option value="windows" {{ $configuracion['tipo_conexion'] == 'windows' ? 'selected' : '' }}>Windows Local</option>
                                                <option value="file" {{ $configuracion['tipo_conexion'] == 'file' ? 'selected' : '' }}>Archivo/Linux</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4" id="networkFields">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="printerIp" name="printer_ip" value="{{ $configuracion['ip_impresora'] }}" placeholder="192.168.1.100">
                                    ...
                                    <div class="col-md-4" id="networkPort">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="printerPort" name="printer_port" value="{{ $configuracion['puerto_impresora'] }}" placeholder="9100">
                                ...
                                <div class="row" id="bluetoothFields" style="display: none;">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="bluetoothAddress" name="bluetooth_address" value="{{ $configuracion['bluetooth_address'] }}" placeholder="00:11:22:33:44:55">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="bluetoothName" name="bluetooth_name" value="{{ $configuracion['bluetooth_name'] }}" placeholder="POS-Printer">
